...
// check if we have a chain of blocks from pindex to chainActive.Tip()
...
bool SetCheckpointPrivKey(std::string strPrivKey)
{
    ...
    CKey key;
    // should we use true or false for SetPrivKey? I set it to false for now to simply let it compile.
